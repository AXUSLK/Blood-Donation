...
class BloodTestUpdateService
{
    public function update(BloodTest $test, array $requestData): BloodTest
    {
    ...
    protected function validate(BloodTest $test, array $data): array
    {
