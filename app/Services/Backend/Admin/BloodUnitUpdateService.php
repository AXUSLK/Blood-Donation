...
class BloodUnitUpdateService
{
    public function update(BloodUnit $bloodUnit, array $requestData): BloodUnit
    {
        ...
        $bloodUnit->update($updateData);

        return $bloodUnit;
    }

    protected function validate(BloodUnit $bloodUnit, array $data): array
    {
