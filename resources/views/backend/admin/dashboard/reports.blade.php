            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donors', 'month')">
                                    <i class="fas fa-calendar-alt mr-2"></i>
                                    This Month's Donors
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donors', 'year')">
                                    <i class="fas fa-calendar mr-2"></i>
                                    This Year's Donors
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donors', 'all')">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('blood_units', 'month')">
                                    <i class="fas fa-calendar-alt mr-2"></i>
                                    This Month's Units
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('blood_units', 'expiring')">
                                    <i class="fas fa-exclamation-triangle mr-2"></i>
                                    Expiring Soon
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('blood_units', 'available')">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donations', 'month')">
                                    <i class="fas fa-calendar-alt mr-2"></i>
                                    This Month's Donations
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donations', 'year')">
                                    <i class="fas fa-calendar mr-2"></i>
                                    This Year's Donations
                                </a>
                                <a href="#" class="list-group-item list-group-item-action" onclick="quickReport('donations', 'all')">
                                    <i class="fas fa-list mr-2"></i>
                                    All Donations
                                </a>
                            </div>
        ...
        document.getElementById('reportContent').innerHTML = `
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ${Object.keys(data.data[0] || {}).map(key => `<th>${key.replace(/_/g, ' ').toUpperCase()}</th>`).join('')}
                        </tr>
                    </thead>
                    <tbody>
            ...
            ${data.data.length > 10 ? `<p class="text-muted">Showing first 10 records of ${data.data.length} total records.</p>` : ''}
        `;
    }
