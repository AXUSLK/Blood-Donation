<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('backend.admin.dashboard') }}" class="brand-link">
        <img src="/images/logo.png" alt="Blood Donation LTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->routeIs('backend.admin.users.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('backend.admin.users.*') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('backend.admin.roles.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('backend.admin.roles.*') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('backend.admin.permissions.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('backend.admin.permissions.*') ? 'active' : '' }}">
